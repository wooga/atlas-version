...
class UPMStrategySpec extends ProjectSpec {
    ...
    def "uses custom wooga application strategies for upm"() {
        ...
        '1.0.0'       | _                   | 7        | "ci"         | _       | "PR-22"                    | "1.0.1-branch.pr.22.7"

        '1.0.0'       | _                   | 1        | "ci"         | _       | "release/1.x"              | "1.0.1-branch.release.1.x.1"
        '1.0.0'       | _                   | 2        | "ci"         | _       | "release-1.x"              | "1.0.1-branch.release.1.x.2"
        ...
        '1.0.0'       | _                   | 1        | "snapshot"   | _       | "master"                   | "1.0.1-master.1"
        ...
        '1.0.0'       | _                   | 1        | "snapshot"   | _       | "develop"                  | "1.0.1-develop.1"
        ...
        '1.0.0'       | _                   | 7        | "snapshot"   | _       | "PR-22"                    | "1.0.1-branch.pr.22.7"

        '0.0.1'       | _                   | 1        | "snapshot"   | _       | "release/1.x"              | "1.0.0-branch.release.1.x.1"
        '1.0.0'       | _                   | 1        | "snapshot"   | _       | "release/1.x"              | "1.0.1-branch.release.1.x.1"
        '1.0.0'       | _                   | 2        | "snapshot"   | _       | "release-1.x"              | "1.0.1-branch.release.1.x.2"
        ...
        '1.0.0'       | _                   | 2        | "snapshot"   | _       | "1.x"                      | "1.0.1-branch.1.x.2"
        '1.0.0'       | _                   | 4        | "snapshot"   | _       | "1.0.x"                    | "1.0.1-branch.1.0.x.4"

        _             | _                   | 1        | "staging"    | _       | "master"                   | "0.0.1-staging.1"
        ...
        '1.0.0'       | _                   | 1        | "staging"    | _       | "master"                   | "1.0.1-staging.1"
        ...
        '1.0.0'       | _                   | 1        | "staging"    | _       | "release/1.x"              | "1.0.1-staging.1"
        '1.0.0'       | _                   | 2        | "staging"    | _       | "release-1.x"              | "1.0.1-staging.1"
        ...
        '1.0.0'       | _                   | 1        | "staging"    | _       | "1.x"                      | "1.0.1-staging.1"
        ...
        // Pre uses timestamp
        '1.0.0'       | _                   | 1        | "pre"        | _       | "master"                   | "1.0.1-pre.#TIMESTAMP"
        ...
        '1.0.0'       | _                   | 1        | "pre"        | _       | "release/1.x"              | "1.0.1-pre.#TIMESTAMP"
        '1.0.0'       | _                   | 2        | "pre"        | _       | "release-1.x"              | "1.0.1-pre.#TIMESTAMP"
        ...
        '1.0.0'       | _                   | 1        | "pre"        | _       | "1.x"                      | "1.0.1-pre.#TIMESTAMP"
        ...
        '1.0.0'       | _                   | 1        | "final"      | _       | "release/1.x"              | "1.0.1"
        '1.0.0'       | _                   | 2        | "final"      | _       | "release-1.x"              | "1.0.1"
        '1.0.0'       | _                   | 3        | "final"      | _       | "release/1.0.x"            | "1.0.1"
        '1.0.0'       | _                   | 4        | "final"      | _       | "release-1.0.x"            | "1.0.1"

        '1.0.0'       | _                   | 1        | "final"      | _       | "1.x"                      | "1.0.1"
        '1.0.0'       | _                   | 3        | "final"      | _       | "1.0.x"                    | "1.0.1"

        '1.0.0'       | _                   | 10       | "ci"         | _       | "test/build01-"            | "1.0.1-branch.test.build.1.10"
        '1.0.0'       | _                   | 22       | "ci"         | _       | "test/build01+"            | "1.0.1-branch.test.build.1.22"
        '1.0.0'       | _                   | 45       | "ci"         | _       | "test/build01_"            | "1.0.1-branch.test.build.1.45"
        '1.0.0'       | _                   | 204      | "ci"         | _       | "test/build01"             | "1.0.1-branch.test.build.1.204"
        '1.0.0'       | _                   | 100      | "ci"         | _       | "test/build.01"            | "1.0.1-branch.test.build.1.100"
        '1.0.0'       | _                   | 55       | "ci"         | _       | "test/build002"            | "1.0.1-branch.test.build.2.55"
        '1.0.0'       | _                   | 66       | "ci"         | _       | "test/build.002"           | "1.0.1-branch.test.build.2.66"
        '1.0.0'       | _                   | 789      | "ci"         | _       | "test/build000000000003"   | "1.0.1-branch.test.build.3.789"
        '1.0.0'       | _                   | 777      | "ci"         | _       | "test/build.000000000003"  | "1.0.1-branch.test.build.3.777"
        '1.0.0'       | _                   | 789      | "ci"         | _       | "test/build000000.000003"  | "1.0.1-branch.test.build.0.3.789"
        '1.0.0'       | _                   | 3        | "ci"         | _       | "test/build.000000.000003" | "1.0.1-branch.test.build.0.3.3"
